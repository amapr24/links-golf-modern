...
export type PartnerCourseType = "Resort" | "Semi-Private" | "Public";
...
export const partnerCourses: PartnerCourse[] = [
  ...
  { slug: "palmas_del_mar", name: "Palmas del Mar", location: "Humacao", discount: 20, tier: "resort", courseType: "Semi-Private" },
