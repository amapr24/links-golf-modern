...
export default function BenefitsSection() {
  ...
  return (
    ...
    >
      ...
      {/* Section chrome matches How It Works (03): outer pt/pb + inner % padding. */}
      <div className="container relative z-10 pt-7 sm:pt-9 md:pt-8 pb-7 sm:pb-9 md:pb-8 lg:pt-6 lg:pb-6 px-4 sm:px-6 md:px-8">
        ...
        >
          ...
          <div className="px-[4%] py-[4%] sm:px-[5%] sm:py-[5%] md:px-[5%] md:py-[3.25%] lg:py-[2.1%]">
            ...
            >
              <p
                className="section-label mb-1 sm:mb-1.5 lg:mb-0.5 text-center text-[10px] sm:text-xs lg:col-span-2 lg:row-start-1 lg:leading-none"
