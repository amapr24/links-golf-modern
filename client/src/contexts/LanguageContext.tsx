...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "benefits.stripTagline": "Member perks at a glance.",
    ...
    "benefits.card.title": "Always in your pocket",
  ...
  es: {
    ...
    "benefits.stripTagline": "Ventajas para socios, de un vistazo.",
    ...
    "benefits.card.title": "Siempre en tu bolsillo",
